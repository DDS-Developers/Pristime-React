		...
		>
			<Modal.Body className="p-4">
				<div className="d-flex justify-content-between align-items-center">
					<div>
						<div className="color-green font-quick-sand-bold mb-2">
							UNIQUE CODE:
						</div>
						<div className="border-green-bold color-green font-quick-sand-bold text-center rounded-pill font-size-20">
							PRSTM41
						</div>
					</div>
					<Image
				...
				<Row className="justify-content-center mb-4">
					<Col lg={4} className="py-3">
						<div className="font-quick-sand-bold color-dark-green font-size-15 mb-4 text-center">
							Congratulations!
						</div>
				...
				<Row className="justify-content-center">
					<Col lg={3} className="d-grid">
						<motion.button
							className="rounded-pill border-green bg-white color-green font-quick-sand-bold d-flex align-items-center justify-content-center position-relative"
							whileHover={{ scale: 1.1 }}
							whileTap={{ scale: 1 }}
							style={{ height: "36px" }}
						>
							<span className="font-size-20">SELESAI</span>
							<div
